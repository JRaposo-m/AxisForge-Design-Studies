"""
validation/abaqus_comparison/uniform_shafts/point_load/timoshenko/case_multi_load_combination/case_multi_load_combination.py
...
the simpler single-load-type cases (case_radial_single_position.py,
case_axial_and_moment.py) are lower-risk by construction.
