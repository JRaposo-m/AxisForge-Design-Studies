"""
validation/abaqus_comparison/scripts/uniform_shafts/point_load/timoshenko/case_axial_and_moment.py
...
in this folder -- see that script's own header and the suite's
top-level README.md for the shared discipline.
