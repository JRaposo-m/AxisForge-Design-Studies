...
# Run by jmrap on Sun Sep 13 23:51:52 2026
#
...
executeOnCaeStartup()
o2 = session.openOdb(name='shaft_1_timoshenko.odb')
#: Model: C:/Users/jmrap/Documents/GitHub/AxisForge-Design-Studies/validation/fem_studies/resolution/scripts/uniform_shafts/point_load/timoshenko/case_axial_and_moment/abaqus_results/shaft_1/shaft_1_timoshenko.odb
...
session.viewports['Viewport: 1'].makeCurrent()
session.Path(name='Path-1', type=NODE_LIST, expression=(('SHAFT_1-1', (1, 9, 
    )), ))
...
pth = session.paths['Path-1']
session.XYDataFromPath(name='XYData-U1', path=pth, includeIntersections=True, 
    projectOntoMesh=False, pathStyle=PATH_POINTS, numIntervals=10, 
    projectionTolerance=0, shape=UNDEFORMED, labelType=TRUE_DISTANCE_X, 
    removeDuplicateXYPairs=True, includeAllElements=False)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
...
session.charts[chartName].autoColor(lines=True, symbols=True)
pth = session.paths['Path-1']
session.XYDataFromPath(name='XYData-UR2', path=pth, includeIntersections=True, 
    projectOntoMesh=False, pathStyle=PATH_POINTS, numIntervals=10, 
    projectionTolerance=0, shape=UNDEFORMED, labelType=TRUE_DISTANCE_X, 
    removeDuplicateXYPairs=True, includeAllElements=False)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
...
session.charts[chartName].autoColor(lines=True, symbols=True)
pth = session.paths['Path-1']
session.XYDataFromPath(name='XYData-UR3', path=pth, includeIntersections=True, 
    projectOntoMesh=False, pathStyle=PATH_POINTS, numIntervals=10, 
    projectionTolerance=0, shape=UNDEFORMED, labelType=TRUE_DISTANCE_X, 
    removeDuplicateXYPairs=True, includeAllElements=False)
import sys
...
abq_ExcelUtilities.excelUtilities.XYtoExcel(
    xyDataNames='XYData-U1,XYData-U2,XYData-U3,XYData-UR2,XYData-UR3', 
